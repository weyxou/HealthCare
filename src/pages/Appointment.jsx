...
const Appointment = () => {
  ...
  return docInfo &&(
    ...
    <div className='flex items-center gap-3 w-full overflow-x-scroll mt-4'>
      ...
      <p onClick={()=> setSlotTime(item.time)} className={'text-sm font-light flex-shrink-0 px-2 py-2 rounded-full cursor-pointer ${item.time == slotTime ? bg-primary text-white : text-gray-400 border border-gray-300}'}  key={index}>
